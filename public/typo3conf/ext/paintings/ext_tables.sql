...
#
# Table structure for table 'tx_paintings_domain_model_style'
#
CREATE TABLE tx_paintings_domain_model_style (
    uid int(11) unsigned NOT NULL auto_increment,
    pid int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_paintings_domain_model_paintings_style_mm'
#
CREATE TABLE tx_paintings_domain_model_paintings_style_mm (
	uid_local int(11) DEFAULT '0' NOT NULL,
	uid_foreign int(11) DEFAULT '0' NOT NULL,
	sorting int(11) DEFAULT '0' NOT NULL,
	KEY uid_local (uid_local),
